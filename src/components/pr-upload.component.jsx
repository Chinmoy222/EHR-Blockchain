...
const PRUpload = (props) => {
  ...
  const onSubmitPR = async (event) => {
    ...
    await ipfs.add(buffer, async (err, ipfsHash) => {
      ...
      await storehash.methods.setHashipfsHashPrescription(ipfsHashValue).send(
        {
          from: accounts[0],
        },
    ...
    <Container>
      <Row className="justify-content-md-center">
        ...
        <Container className="justify-content-center">
          ...
          <hr/>
          <Button onClick={onClickPR}> Get Transaction Receipt </Button>
